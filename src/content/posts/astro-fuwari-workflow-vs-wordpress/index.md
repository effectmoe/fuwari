...
image: ./cover.jpg
manga_tldr:
  - { src: "./manga/panel-1.jpg", caption: "「ブログ運用って、こんなに複雑だっけ？」" }
  - { src: "./manga/panel-2.jpg", caption: "「全部 Markdown で揃えたら、どうなる？」" }
  - { src: "./manga/panel-3.jpg", caption: "「一つの源から、すべてが生まれる」" }
  - { src: "./manga/panel-4.jpg", caption: "「AI 時代のブログは、ここから始まる」" }
tags:
  - Astro
  - Fuwari
  - Obsidian
