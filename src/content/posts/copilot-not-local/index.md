...
ただし、この説明を仕事で使うCopilot全体へ広げることはできません。なお、Phi Silicaは**2026年9月時点**の情報として、Windows InsiderとリテールでAion Instructへの展開に伴って削除される予定です。端末内で動く機能も、名前と仕様を固定したまま扱わず、確認を続ける必要があります。
...
また、CopilotはMicrosoftが自社でホストするモデルだけでなく、OpenAIとAnthropicのモデルを副処理者として利用します。どのモデルを使える設定にしているかで、確認するべき契約上の扱いと保持の扱いも変わります。
