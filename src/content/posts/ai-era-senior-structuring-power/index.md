...
この一連の翻訳作業を、筆者は [**DFB**](https://tony.effect.moe/posts/dfb-method-introduction/) **（D**ecompose / **F**rame / **B**uild**）** と呼んでいる。詳しい中身は別記事に譲るが、要するに「**経験 → AIへの問い → AIの出力の検閲**」を一つの型にしたものだ。
