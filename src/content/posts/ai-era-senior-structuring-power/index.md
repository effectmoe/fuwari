...
### 条件1: 分解(D) — 暗黙知を3〜5個のチェックポイントに分ける

KKDの "勘" は、丸ごとでは AIに伝わらない。**判断の根拠を3〜5個のチェックポイントに分ける** ことから始まる。冒頭の漫画で「5軸に割れば」と書いていたのは、まさにこの D（分解）のこと。「5」という数は固定ではなく、**今回たまたまこの例が5つだっただけ**だ。

> 例：ベテラン社労士が「この就業規則は危険」と直感する  
> → 分けてみると ①過去の判例とどれくらい似ているか ②労基署が最近どこを厳しく見ているか ③このクライアントの業界の事故率 ④文章のどこが曖昧か ⑤直す場合のコストがどれくらい大きいか、の **5つのチェックポイント** が頭の中で同時に動いていた

ここまで分ければ、AIに「この5つのチェックポイントで見て」と頼める。

### 条件2: 枠化(F) — 同じ構造を毎回使い回す

一度分けたチェックポイントを **毎回手で組み直さない**。テンプレート化して、入力枠だけ差し替える状態にする。
