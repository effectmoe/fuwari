...
image: "./cover.jpg"
imageAlt: "クラウドに社内情報を送る構成と、社内で完結する構成を見比べる図解風アイキャッチ"
...
*図1: 「使う／使わない」の二択ではなく、情報がどこを通るかを設計する。*
...
*図2: プライバシーを選ばれる理由にする力学は、消費者向けから企業のAI導入へも広がっている。*
