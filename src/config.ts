	...
	reviews: {
		...
		testimonials: [
			...
			},
			{
				...
				date: "2026-06",
				rating: 5,
				headline: "「なぜそうなるのか」本質から教えてくれる先生",
			...
			{
				course: "ClaudeとNotionを使い「第2の脳」構築メソッドを実演！",
				reviewer: "男性 40代",
				date: "2026-06",
				rating: 5,
				headline: "この講座は「自分のやりたいことが前に進む講座」でした",
				text: "聞いて終わる講座ではなく、その場でコンサルをしながらシステムを構築して頂き成果物もついてきます。コストパフォーマンスがめちゃくちゃ高い講座だと思いました。",
			},
			{
			...
			},
			{
				...
				date: "2026-05",
				rating: 5,
				headline: "1人では繋げないObsidian×Claude連携を学べた",
			...
			},
			{
				...
				date: "2026-06",
				rating: 5,
				headline: "リアルタイムの書き込みでとても分かりやすい",
			...
			},
			{
				...
				date: "2026-05",
				rating: 5,
				headline: "前提から丁寧で安心、月額サービスも継続したい",
			...
			},
			{
				...
				date: "2026-05",
				rating: 5,
				headline: "初心者でもペースを合わせてもらい楽しく学べた",
			...
			},
			{
				...
				date: "2026-05",
				rating: 5,
				headline: "概念から学んでClaude Codeが定着した",
