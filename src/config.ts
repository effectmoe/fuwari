...
export const faqConfig = {
	general: [
		{
			...
			a: "はい。むしろ初心者の方が対象です。テクニックの前に「なぜそうなるのか」から、専門用語をかみくだいて説明します。受講生レビューでも『難しい言葉を使わない』と多数評価いただいています。",
		},
		{
			q: "どんなことを教えてもらえますか？",
			a: "Claude / Claude Code / Codex などのAIツール活用、Notion・Obsidianでの知識管理、LLMO（AI検索対策）、AIエージェント（AI社員）づくり、ローカルAIなど。あなたの仕事に合わせて一緒に作りながら学べます。",
		},
		{
			q: "個人や小さな会社でも相談できますか？",
			a: "はい。1人〜小規模事業の方が『1人で10倍の成果』を目指せるよう、AIで業務を自動化・効率化する設計をお手伝いします。月額のコンサルティング（伴走支援）もあります。",
		},
		{
			q: "AIシステムやアプリの開発も頼めますか？",
			a: "はい。社内向けのAIシステム構築、AIアプリ開発、LLMO対策の代行まで対応しています。「AIで事業を構造化して加速する」のが私たちの専門です。",
		},
		{
			q: "講座はどこで受けられますか？",
			a: "スキルシェア最大手「ストアカ」で開講しています（評価4.94／レビュー209件・プラチナ講師）。各記事の最後に、その内容に関連する講座へのリンクを置いています。",
		},
		{
			q: "このブログは何がテーマですか？",
			a: "「構造化」が軸です。物事を整理して構造化できる人が、AI時代にいちばん得をする——という考えのもと、AIを実際に使って事業や知識を構造化する方法を、実装しながら発信しています。",
		},
	],
	...
	glossary: [
		{
			q: "Claude（クロード）とは？",
			a: "Anthropic社が作った対話型AIです。文章の作成・要約・分析や、コードを書くのが得意で、長い文章を丁寧に扱えるのが特徴です。",
		},
		{
			q: "Claude Code（クロードコード）とは？",
			a: "Claude をコード作成・開発に特化させた道具です。「こういうアプリを作りたい」と日本語で頼むと、AIが実際にコードを書いて形にしてくれます。",
		},
		{
			q: "Codex（コーデックス）とは？",
			a: "OpenAI（ChatGPTの会社）のコード作成AIです。Claude Code と似た役割で、プログラムを書くのを手伝ってくれます。",
		},
		{
			q: "MCP とは？",
			a: "AIに『このフォルダやアプリを使っていいよ』と許可を出し、AIが自分でファイルを読み書きしたり外部の道具を使えるようにする「橋渡しの仕組み」です。正式名称は Model Context Protocol。",
		},
		{
			q: "Obsidian（オブシディアン）とは？",
			a: "文字（マークダウン）でメモを書きためるアプリです。メモ同士をリンクでつなげられ、自分だけの知識データベースを作れます。データは自分のパソコンに保存されます。",
		},
		{
			q: "Notion（ノーション）とは？",
			a: "メモ・文書・データベース・タスク管理をまとめてできる万能ツールです。チームでの共有や、見やすい資料づくりが得意です。",
		},
		{
			q: "LLMO とは？",
			a: "ChatGPTやPerplexityなどのAI検索に、自分のサイトを見つけてもらい・引用してもらうための対策です。これまでのSEO（Google検索対策）のAI時代版にあたります。",
		},
		{
			q: "AIエージェント（AI社員）とは？",
			a: "指示を出すと、複数の作業を自分で順番に考えて実行してくれるAIです。まるで社員のように、調べもの・資料作成・処理などをまかせられます。",
		},
		{
			q: "ローカルLLM（ローカルAI）とは？",
			a: "インターネット上のサービスではなく、自分のパソコンの中で動かすAIのことです。情報が外に出ないので、プライバシーやコスト面で安心して使えます。",
		},
		{
			q: "E-E-A-T とは？",
			a: "経験・専門性・権威性・信頼性の頭文字です。GoogleやAIが「この情報は信頼できるか」を判断する目安で、発信者の実績や出典の明示が大切になります。",
		},
		{
			q: "構造化データ（JSON-LD）とは？",
			a: "ページの内容を、検索エンジンやAIが正確に読み取れる「決まった書式の説明書き」です。記事の著者・日付・評価などを機械に伝え、検索やAIに引用されやすくします。",
		},
	],
};
